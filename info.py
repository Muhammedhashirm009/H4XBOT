...
API_ID = int(environ.get('API_ID', '25467884'))
API_HASH = environ.get('API_HASH', '05a687da36243593d4eb624f46375341')
BOT_TOKEN = environ.get('BOT_TOKEN', "5858563808:AAFRnnYQdomkB_NxOvyHUEJXWL2c_GLYWlQ")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001704871970')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://hashir:gUeHLPQ5i7ARzwkA@cluster0.rvkb8jf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001782419622'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'H4XMODS')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True)
IMDB = is_enabled((environ.get('IMDB', "True")), False)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Movies Adaa™](https://t.me/H4XMODS)</b>⚡\n\nName: {file_caption} \n\n⚙️ <b>Size: </b><code>{file_size}</code>🔥  ↭ <b>Join Now [H4XMODS™](https://t.me/H4XMODS)</b> ↭  🔥")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "⚡<b>File uploaded by [Movies Adaa™](https://t.me/H4XMODS)</b>⚡\n\nName: {file_caption} \n\n⚙️ <b>Size: </b><code>{file_size}</code>🔥  ↭ <b>Join Now [H4XMODS™](https://t.me/H4XMODS)</b> ↭  🔥")
...
# _______________________________________H4XMODS___________________________________________________________ #
...
DOWNLOAD_TEXT_URL = "https://t.me/H4XMODS"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/H4XMODS"
