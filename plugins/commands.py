...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://telegram.me/H4XMODS')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/H4XMODS"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/H4XMODS"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/H4XMODS')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://youtube.com/@H4XMODS')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
